...
// Tabela de multiplicadores por produto/categoria
const MultipliersTable = styled.table`
  width: 100%;
...
// Wrapper para a versão em página (não modal)
...
// Extrai o conteúdo do regulamento para reuso (modal e página)
function RegulamentoBody() {
  return (
    <>
      <Section>
      ...
      <Section>
        <h3 id="produtoxpontos">3. Sistema de Pontuação</h3>
        ...
        <h4>3.2 Tabela de Pontuação por Produto</h4>
        <p>Os multiplicadores por categoria/produto atualmente praticados são:</p>
        <MultipliersTable>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td>Placa ST (todas as espessuras)</td>
              <td>0,5x</td>
              <td>Produto de menor margem</td>
            </tr>
            <tr>
              <td>Placa RU (todas as espessuras)</td>
              <td>1,0x</td>
              <td>Produto intermediário</td>
            </tr>
            <tr>
              <td>Glasroc X (placas)</td>
              <td>2,0x</td>
              <td>Produto estratégico</td>
            </tr>
            <tr>
              <td>Placomix</td>
              <td>1,0x</td>
            ...
            <tr>
              <td>Malha Glasroc X</td>
              <td>2,0x</td>
              <td>Acessório estratégico</td>
            </tr>
            <tr>
              <td>Basecoat Glasroc X</td>
              <td>2,0x</td>
              <td>Produto de valor agregado</td>
            </tr>
          </tbody>
        </MultipliersTable>

        <p style={{ marginTop: '8px' }}>
          Os multiplicadores podem ser alterados pela Fast a qualquer momento, sem aviso prévio.
          Promoções e campanhas podem aplicar multiplicadores especiais por tempo limitado.
        </p>

        <h4>3.3 Validação e Processamento:</h4>
        <ul>
...
// Versão em página do Regulamento, para uso no menu lateral "Como ganhar pontos?"
export function RegulamentoPage() {
  return (
    <PageWrapper>
      <PageHeader>
        <h2>Como ganhar pontos?</h2>
        <p>Entenda as regras e os multiplicadores de pontuação do programa</p>
      </PageHeader>
      <Content>
        <RegulamentoBody />
      </Content>
