    ...
    return (
        <Container>
            <Content>
                <StatsGrid>
                    <StatCard>
                        <StatValue>{stats.saldoAtual}</StatValue>
                        <StatLabel>Pontos Disponíveis</StatLabel>
                    </StatCard>
                    <StatCard>
                        <StatValue>{stats.totalGanhos}</StatValue>
                        <StatLabel>Total Ganho</StatLabel>
                    </StatCard>
                    <StatCard>
                        <StatValue>{stats.totalGastos}</StatValue>
                        <StatLabel>Total Gasto</StatLabel>
                    </StatCard>
                    <StatCard>
                        <StatValue>{stats.pedidosAnalisados}</StatValue>
                        <StatLabel>Pedidos Enviados</StatLabel>
                    </StatCard>
                </StatsGrid>
                ...
                <ProfileCard>
                    <ProfileHeader>
                        ...
                        <ProfileInfo>
                            ...
                            <ProfileDetail>
                                <FiUser />
                                {user?.tipo === 'CPF' ? 'Pessoa Física' : 'Pessoa Jurídica'}
                            </ProfileDetail>
                            <ProfileDetail>
                                <FiMail />
                                {user?.email}
                        ...
                        {!isEditing && (
                            <EditButton onClick={() => setIsEditing(true)} disabled={loading}>
                                <FiEdit3 />
                                Editar
                            </EditButton>
                        )}
